...
def get_args():
    ...
    parser.add_argument('--model_size', help='Number of units on the first layer', type=int, default=300)
    ...
    parser.add_argument('--output_activation', help='Activation function for the output unit', type=str, default='softmax')
    ...
    parser.add_argument('--batch_normalization', help='Apply batch normalization to recurrent layers', type=int, default=0)
    ...
    parser.add_argument('--sent_len_perc', help='Maximum length of a sentence as a percentile in word-based features', type=float, default=0.9)
    parser.add_argument('--word_len_perc', help='Maximum length of a word as a percentile in character-based features', type=float, default=0.9)
