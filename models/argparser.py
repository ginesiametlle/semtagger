...
def get_args():
    ...
    parser.add_argument('--data_words', help='File containing processed word sem-tagged sentences', type=str, required=True)
    parser.add_argument('--data_chars', help='File containing processed character sem-tagged sentences', type=str, default='')
