...
def get_args():
    ...
    parser.add_argument('--raw_data', help='File containing sem-tagged sentences from the PMB', type=str, required=True)
    ...
    parser.add_argument('--verbose', help='Keras verbose', type=bool, default=False)
    parser.add_argument('--test_size', help='Proportion of the sentences to use as a test set', type=float, default=0.2)
    parser.add_argument('--cross_validate', help='Estimate hyperparameters using cross-validation', type=bool, default=False)
